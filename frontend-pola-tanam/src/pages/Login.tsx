...
const Login: React.FC = () => {
  ...
  Lupa password?
        ...
        <div className="mt-8 text-center border-t border-gray-100 pt-6">
          {/* Tombol Demo untuk Presentasi */}
          <button
            onClick={() => navigate('/dashboard')}
            className="w-full mb-4 flex items-center justify-center gap-2 py-3 px-4 border-2 border-dashed border-agri-green rounded-lg text-sm font-bold text-agri-green hover:bg-green-50 transition-colors"
          >
          ...
          <p className="text-xs text-gray-400 mb-4">Akses langsung ke dashboard untuk keperluan presentasi.</p>
