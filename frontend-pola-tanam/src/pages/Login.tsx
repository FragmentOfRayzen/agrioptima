      ...
      <div className="max-w-md w-full bg-white p-8 rounded-xl shadow-lg border border-gray-100">
        ...
        <form className="space-y-6" onSubmit={handleLogin}>
          ...
          <button
            type="submit"
            disabled={loading || demoLoading}
            className={"w-full flex justify-center py-3.5 px-4 rounded-lg shadow-md text-sm font-bold text-white bg-agri-green hover:bg-green-700 transition-all " + (loading ? "opacity-70 cursor-not-allowed" : "")}
          >
        ...
        <button
          ...
          disabled={loading || demoLoading}
          className={"w-full flex items-center justify-center gap-2 py-3.5 px-4 rounded-lg border-2 border-amber-400 bg-amber-50 hover:bg-amber-100 text-amber-700 font-bold text-sm transition-all shadow-sm " + (demoLoading ? "opacity-70 cursor-not-allowed" : "")}
        >
          {demoLoading ? "Memuat Mode Demo..." : "Coba Mode Demo (Tanpa Registrasi)"}
        </button>
